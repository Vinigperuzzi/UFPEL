...
int main(int argc, char *argv[]){
    ...
    printf("\n\nPrograma executado com sucesso, por favor, procure o arquivo chamado \"saidaMaior.txt\" no diretório em que o programa foi executado.\n\n");
...
void escrevearq(int nCPU, int linhas, CPU processador[nCPU], processo process[linhas]){
    ...
    if((arq = fopen("saidaMaior.txt", "w")) == NULL){
